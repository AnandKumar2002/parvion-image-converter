...
export const features: Feature[] = [
  ...
  { id: "feat_webp-converter", categorySlug: "convert", name: "WebP Converter", slug: "webp-converter", description: "Create modern, fast-loading images for the web.", icon: "lucide:globe", highlight: false, isActive: true, order: 2, uiType: "converter" },
  ...
  { id: "feat_aspect-ratio", categorySlug: "tools", name: "Change aspect ratio", slug: "aspect-ratio", description: "Change the shape to fit social media.", icon: "lucide:monitor", highlight: false, isActive: true, order: 4, uiType: "editor" },
  { id: "feat_watermark", categorySlug: "tools", name: "Add Watermark", slug: "watermark", description: "Protect your images with a custom watermark.", icon: "lucide:stamp", highlight: false, isActive: true, order: 5, uiType: "editor" },
